...
<div class="base shortstory">
	<div class="dpad">
		...
		<p class="binfo small">Автор: {result-author} від {result-date}, переглянуло: {views}</p>
		<div class="maincont">
...
<div class="dpad searchitem">
	...
	{result-date} | {link-category} | Автор: {result-author} | [not-group=5][edit]Редагувати[/edit][/not-group]
</div>
[/shortresult]
[/searchposts]
[searchcomments]
...
<div class="dpad searchitem">
	<b>[result-link]{result-title}[/result-link]</b><br />
	{result-date} | {link-category} | Автор: {result-author} | [com-edit]Змінити[/com-edit] | [com-del]Видалити[/com-del]
</div>
[/shortresult]
[/searchcomments]
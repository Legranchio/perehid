[pmlist]
<h2 class="heading" style="margin: 0;">Перелік повідомлень</h2>
[/pmlist]
[newpm]
<h2 class="heading" style="margin: 0;">Нове повідомлення</h2>
[/newpm]
[readpm]
<h2 class="heading" style="margin: 0;">Ваші повідомлення</h2>
[/readpm]
<div class="basecont">
<div class="pm_status">
	...
	<div class="bcomment">
		...
		<div class="rcol">
			<div class="combox">
				...
				//]]></script>
				<div class="infbtn">
					<span id="pinfb" class="thide" title="Інформація до новини">Інформація до новини</span>
				...
				<div class="comedit">
					...
					<span class="arg">[complaint]Поскаржитися[/complaint]</span>
					<span class="arg">[ignore]Ігнорувати[/ignore]</span>
					<span class="arg">[del]Видалити[/del]</span>
					<div class="clr"></div>
				</div>
			</div>
		</div>

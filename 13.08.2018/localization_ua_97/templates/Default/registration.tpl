...
<div class="baseform">
	...
	[registration]
		<tr>
			...
			<td>
				<input type="text" name="name" id='name' style="width:175px; margin-right: 6px;" class="f_input" /><input class="bbcodes" style="height: 22px; font-size: 11px;" title="Перевірити доступність логіну для реєстрації" onclick="CheckLogin(); return false;" type="button" value="Перевірити ім'я" />

<div class="pheading"><h2>Зворотній зв'язок</h2></div>
<div class="baseform">
	<table class="tableform">
	[not-logged]
		<tr>
			<td class="label">
				Ваше ім'я:<span class="impot">*</span>
			</td>
	...
	<div class="fieldsubmit">
		<button name="send_btn" class="fbutton" type="submit"><span>Надіслати</span></button>
	</div>
</div>
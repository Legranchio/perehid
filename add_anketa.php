...
if($_POST['send']) {
	...
	if(!$_POST['step2']) {
		$form_cont = "Я, учасник лотереї «Зелена Карта» (далі - Учасник) даним документом даю свою добровільну згоду на використання, обробку, розміщення в базах даних, накопичення, оновлення, а також внесення змін, стосовно моїх персональних даних ПП “Перехід” (далі - Організатор-консультант), виключно для здійснення повноважень, необхідних для участі в лотереї «Зелена Карта» та оформлення візи для виїзду в США.</br></br>

Даю також свою згоду на передачу моїх персональних даних комерційним партнерам, особам, які уповноважені Організатором-консультантом для здійснення безпосередньої обробки даних для зазначених цілей, а також на запит уповноваженого державного органу, виключно в межах його компетенції, відповідно до положень Закону України «Про захист персональних даних» від 01.06.2010 р. № 2297-VI.</br></br>

Погоджуюся на оформлення, (в т.ч. підписання), подачу усіх необхідних документів, представлених мені Організатором-консультантом, які пов’язані з моєю участю в лотереї «Зелена Карта», зокрема в разі виграшу, на отримання мною необхідної візи для виїзду в США.</br></br>

За надані Організатором-консультантом на підставі відповідного договору послуги, зобов’язуюсь провести оплату, згідно оформлених актів виконаних робіт (наданих послуг).
</br></br>
Примітка. Відповідно до ст. 2 Закону України «Про захист персональних даних» від 01.06.2010 р. № 2297-VI, згода суб'єкта персональних даних - це будь-яке документоване, зокрема, письмове, добровільне волевиявлення фізичної особи щодо надання дозволу на обробку його персональних даних відповідно до сформульованої метою їх обробки.<br></br>";
